...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.randn(
            num_filters * h * w // 4, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        z, cache3 = affine_forward(x, W3, b3)
        scores = z
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        loss += (self.reg / 2) * np.sum(W1 ** 2)
        loss += (self.reg / 2) * np.sum(W2 ** 2)
        loss += (self.reg / 2) * np.sum(W3 ** 2)
